...
int main(int argc, char *argv[])
{
    ...
    QObject::connect(&necinfo, SIGNAL(new_Contact_Info(const QIcon &, const QString &, const QString &)),
                    &mainpage,SLOT(new_Contact_Info(const QIcon &, const QString &, const QString &)));
